...
class _LoginPageState extends State<LoginPage> {
  ...
  /*@override
  void _dispose(TextEditingController myController) {
  ...
  signIn(String email, String pass) async {
    Map data = {'logemail': email, 'logpassword': pass};
  ...
  Widget _submitButton(TextEditingController emailController,
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _submitButton(emailController, passwordController),
                Row(
